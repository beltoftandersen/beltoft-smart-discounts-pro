...
**Beltoft Smart Discounts for WooCommerce - Pro** unlocks advanced discount features on top of the free Beltoft Smart Discounts plugin. Create sophisticated promotions with BOGO deals, bundle discounts, role-based pricing, first-order discounts, and more.
...
* Beltoft Smart Discounts for WooCommerce (free plugin) version 1.0.0 or higher
...
3. Activate the Pro plugin through the "Plugins" menu in WordPress
...
Yes. Beltoft Smart Discounts for WooCommerce - Pro is an add-on that requires the free "Beltoft Smart Discounts for WooCommerce" plugin to be installed and active.

= How do I get a license key? =

Purchase a license at https://beltoft.net/plugins/beltoft-smart-discounts-pro/ and enter the key in the License tab.
...
= 2.0.0 =
Major rebrand and remote licensing. Enter your new license key after updating.
